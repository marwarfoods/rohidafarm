...
<section class="about-difference-section">
    <div class="container">
        ...
        <div class="text-center" data-aos="fade-up">
            <span class="text-uppercase fw-bold mb-2 d-block sustainability-eyebrow" style="color: #8B5A2B; font-size: 0.85rem; letter-spacing: 2px;">Our Core Philosophy</span>
            <h2 class="section-title font-heading fw-bold" style="color: #362518;">What We Stand For</h2>
        </div>
        ...
        <div class="row g-4 mt-2 justify-content-center">
            ...
            <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
                <div class="about-card philosophy-card text-center d-flex flex-column align-items-center justify-content-center h-100">
                    ...
                    <h4 class="philosophy-title mb-0">Purity</h4>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
                <div class="about-card philosophy-card text-center d-flex flex-column align-items-center justify-content-center h-100">
                    ...
                    <h4 class="philosophy-title mb-0">Tradition</h4>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
                <div class="about-card philosophy-card text-center d-flex flex-column align-items-center justify-content-center h-100">
                    ...
                    <h4 class="philosophy-title mb-0">Farm-Rooted</h4>
                </div>
            </div>
            ...
            <div class="col-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
                <div class="about-card philosophy-card text-center d-flex flex-column align-items-center justify-content-center h-100">
                    ...
                    <h4 class="philosophy-title mb-0">Trust, Made Visible</h4>
                </div>
            </div>
