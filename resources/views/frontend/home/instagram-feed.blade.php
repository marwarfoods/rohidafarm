...
<section class="instagram-section py-5 position-relative overflow-hidden" style="background-color: #fafbfc; border-top: 1px solid var(--border-color);">
    <div class="container py-2">
        ...
        <div class="text-center mb-4 mb-md-5" data-aos="fade-up">
            ...
            <p class="text-muted mt-2 max-w-2xl mx-auto" style="font-size: 0.92rem; max-width: 620px;">
                Explore daily moments from Marwar Foods: traditional A2 Bilona ghee churning, organic farming, and authentic Vedic recipes.
            </p>
            <div class="d-flex flex-wrap justify-content-center gap-2 mt-2" style="font-size: 0.8rem; font-weight: 500;">
                <span class="text-secondary">#MarwarFoods</span>
                <span class="text-secondary">•</span>
                <span class="text-secondary">#PureA2Ghee</span>
                <span class="text-secondary">•</span>
                <span class="text-secondary">#BilonaGhee</span>
                <span class="text-secondary">•</span>
                <span class="text-secondary">#OrganicLiving</span>
            </div>
        </div>
    </div>
    ...
    @php
        ...
        $row1Posts = [
            ['img' => asset('images/baner-1.png'), 'likes' => '2.4k', 'comments' => '142', 'caption' => 'Golden A2 Bilona Ghee fresh batch! 💛'],
            ['img' => asset('images/home-image-pc.png'), 'likes' => '3.1k', 'comments' => '209', 'caption' => 'Pure Tharparkar Cows grazing in pastures 🐄🌿'],
            ['img' => 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?q=80&w=400&auto=format&fit=crop', 'likes' => '1.9k', 'comments' => '98', 'caption' => 'Traditional clay pot churning at 4 AM 🏺✨'],
            ['img' => 'https://images.unsplash.com/photo-1471193945509-9ad0617afabf?q=80&w=400&auto=format&fit=crop', 'likes' => '1.5k', 'comments' => '76', 'caption' => 'Wood Pressed Kachi Ghani Mustard Oil 🌾💛'],
            ['img' => 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?q=80&w=400&auto=format&fit=crop', 'likes' => '2.8k', 'comments' => '180', 'caption' => 'Raw Forest Honey straight from hives 🍯🐝'],
            ['img' => asset('images/home-image-mobile.png'), 'likes' => '4.2k', 'comments' => '310', 'caption' => 'Eco-friendly glass jar packaging delivered! 📦❤️'],
            ['img' => 'https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=400&auto=format&fit=crop', 'likes' => '3.8k', 'comments' => '245', 'caption' => 'Fresh organic spices harvested from farm 🌱⚡'],
            ['img' => 'https://images.unsplash.com/photo-1628088062854-d1870b4553da?q=80&w=400&auto=format&fit=crop', 'likes' => '5.1k', 'comments' => '412', 'caption' => 'A2 Bilona Ghee on hot parathas! 🥞🔥']
        ];

        $row2Posts = [
            ['img' => 'https://images.unsplash.com/photo-1500595046743-cd271d694d30?q=80&w=400&auto=format&fit=crop', 'likes' => '4.7k', 'comments' => '320', 'caption' => 'Sunlit morning at Marwar organic farm 🌄🌾'],
            ['img' => 'https://images.unsplash.com/photo-1527153857715-3908f2bae5e8?q=80&w=400&auto=format&fit=crop', 'likes' => '2.9k', 'comments' => '174', 'caption' => 'Nourishing calves with love & care 🐮💛'],
            ['img' => asset('images/baner-1.png'), 'likes' => '3.6k', 'comments' => '210', 'caption' => 'Danedar granular texture of pure Ghee 🧈✨'],
            ['img' => 'https://images.unsplash.com/photo-1589927986089-35812388d1f4?q=80&w=400&auto=format&fit=crop', 'likes' => '1.8k', 'comments' => '88', 'caption' => 'Slow wood-fire flame clarification 🪵🔥'],
            ['img' => 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?q=80&w=400&auto=format&fit=crop', 'likes' => '2.2k', 'comments' => '115', 'caption' => 'Earthenware storage for rich aroma 🏺🍯'],
            ['img' => 'https://images.unsplash.com/photo-1471193945509-9ad0617afabf?q=80&w=400&auto=format&fit=crop', 'likes' => '3.3k', 'comments' => '201', 'caption' => 'Pure Groundnut Oil cold pressed naturally 🥜💛'],
            ['img' => asset('images/home-image-pc.png'), 'likes' => '4.0k', 'comments' => '290', 'caption' => 'Pure Vedic tradition in every drop 🌿✨'],
            ['img' => 'https://images.unsplash.com/photo-1587049352846-4a222e784d38?q=80&w=400&auto=format&fit=crop', 'likes' => '2.5k', 'comments' => '150', 'caption' => '100% Chemical-free natural wellness 🍯🌿']
        ];
    @endphp
            ...
            <div class="marquee-track marquee-track-left">
                @foreach(array_merge($row1Posts, $row1Posts) as $post)
                    <div class="insta-marquee-item px-2">
                        <a href="{{ $instaUrl }}" target="_blank" rel="noopener noreferrer" class="insta-square-card d-block position-relative rounded-4 overflow-hidden shadow-sm text-decoration-none group">
