...
<div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
    <h1 class="display-6 font-heading fw-bold m-0">Create Coupon</h1>
        ...
        <form action="{{ route('admin.coupons.store') }}" method="POST">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        <input type="text" name="code" id="couponCodeInput" class="form-control bg-light border p-3 text-uppercase" placeholder="e.g. WELCOME10" required style="border-top-left-radius: 8px; border-bottom-left-radius: 8px;">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" step="0.01" name="discount_value" class="form-control bg-light border p-3" placeholder="e.g. 10" required>
                </div>
            </div>
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="number" step="0.01" name="min_amount" class="form-control bg-light border p-3" placeholder="0.00">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-bold">Maximum Discount (if %)</label>
                    <input type="number" step="0.01" name="max_discount" class="form-control bg-light border p-3" placeholder="Leave blank for no limit">
                </div>
                <div class="col-md-4">
                    <label class="form-label fw-bold">Total Usage Limit</label>
                    <input type="number" name="usage_limit" class="form-control bg-light border p-3" placeholder="e.g. 100 uses max">
                </div>
            </div>
            ...
            <div class="row g-4 mb-5 border-bottom pb-5">
                <div class="col-md-6">
                    ...
                    <input type="datetime-local" name="active_from" class="form-control bg-light border p-3">
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-bold">Valid Until Date</label>
                    <input type="datetime-local" name="active_until" class="form-control bg-light border p-3">
                </div>
            </div>
            ...
            <div class="form-check form-switch mb-4">
                <input class="form-check-input" type="checkbox" name="is_active" value="1" id="isActiveSwitch" checked style="width: 2.5em; height: 1.25em;">
