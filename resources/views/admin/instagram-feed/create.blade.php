...
<div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom">
    <h1 class="display-6 font-heading fw-bold m-0">
        <i class="bi bi-instagram text-danger me-2"></i>Add Instagram Post
    </h1>
...
<div class="card border-0 rounded-4 shadow-sm bg-white p-4">
    <form method="POST" action="{{ route('admin.instagram-feed.store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row g-4">
            ...
            <div class="col-md-8">
                ...
                <input type="text" name="caption" class="form-control rounded-3" value="{{ old('caption') }}" placeholder="Optional caption text" maxlength="255">
            </div>
            ...
            <div class="col-md-4">
                ...
                <select name="row" class="form-select rounded-3" required>
                    <option value="1" {{ old('row', 1) == 1 ? 'selected' : '' }}>Row 1 (Top — scrolls left)</option>
                    <option value="2" {{ old('row') == 2 ? 'selected' : '' }}>Row 2 (Bottom — scrolls right)</option>
                </select>
            ...
            <div class="col-md-8">
                ...
                <input type="url" name="link_url" class="form-control rounded-3" value="{{ old('link_url') }}" placeholder="https://instagram.com/p/...">
            </div>
        ...
        <div class="mt-4 d-flex gap-2">
            <button type="submit" class="btn btn-success fw-bold px-4 rounded-3">
                <i class="bi bi-save2-fill me-1"></i> Save Post
            </button>
