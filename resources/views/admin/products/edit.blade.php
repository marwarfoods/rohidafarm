        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm rounded-4 bg-white mb-4">
                <div class="card-header bg-white rounded-top-4 px-4 py-3 border-bottom d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-success btn-sm rounded-pill px-3 {{ ($product->use_global_faqs ?? true) ? 'd-none' : '' }}" id="btnAddFaq">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="p-3 bg-light rounded-3 border mb-3">
                        <div class="form-check form-switch d-flex align-items-center gap-2 p-0 m-0">
                            <input class="form-check-input ms-0 me-2" type="checkbox" name="use_global_faqs" value="1" id="useGlobalFaqsToggle" 
                                   {{ old('use_global_faqs', $product->use_global_faqs ?? true) ? 'checked' : '' }} style="width: 2.4em; height: 1.25em; cursor: pointer;">
                            <div>
                    ...
                    <div id="globalFaqNotice" class="alert alert-success border-0 bg-success-subtle text-success py-2.5 px-3 rounded-3 d-flex align-items-center gap-2 mb-0 {{ ($product->use_global_faqs ?? true) ? '' : 'd-none' }}" style="font-size: 0.85rem;">
                    ...
                    <div id="customFaqsSection" class="{{ ($product->use_global_faqs ?? true) ? 'd-none' : '' }} mt-3">
                        ...
                        <div id="faqsContainer" class="d-flex flex-column gap-3">
                            ...
                            <div class="text-center py-3 text-muted" id="faqsEmpty" style="font-size:0.85rem; {{ $product->faqs->count() > 0 ? 'display:none;' : '' }}">
                                <i class="bi bi-question-circle me-1"></i> No custom FAQs added yet.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body p-4">
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="show_on_home" id="show_on_home" value="1"
                               {{ old('show_on_home', $product->show_on_home ?? true) ? 'checked' : '' }}>
                    ...
                    <div class="form-check form-switch mb-3">
                        <input class="form-check-input" type="checkbox" name="show_on_shop" id="show_on_shop" value="1"
                               {{ old('show_on_shop', $product->show_on_shop ?? true) ? 'checked' : '' }}>
