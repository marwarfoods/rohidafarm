...
<div class="mb-4">
    ...
    <h2 class="font-heading fw-bold text-dark mt-2">Add Customer Review</h2>
    <p class="text-muted m-0">This appears in the homepage testimonial slider — photo on one side, review text on the other.</p>
</div>
...
<div class="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white">
    <form action="{{ route('admin.customer-reviews.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @include('admin.customer_reviews._form', ['customerReview' => null])
        <div class="col-12 mt-4 border-top pt-4">
            <button type="submit" class="btn btn-success px-5 py-3 rounded-pill text-uppercase fw-semibold" style="font-size: 0.8rem; letter-spacing: 0.5px;">Save Customer Review</button>
        </div>
    </form>
</div>
@endsection
